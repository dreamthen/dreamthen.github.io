...
# 微信小程序框架Taro
  ...
  taro-ui UI组件库的大小也改善了很多,尤其是支持了按需加载UI组件库方面,但是这里又出现了一个问题,taro-ui UI组件库在taro 2.1.0以后的版本生产环境也就是我所说的yarn run build:weapp,也可以使用我上述所说的将全局环境变量置为production,之后'dev:weapp'的方式,公共样式就不会导入进来,此bug在taro 2.1.5版本修复。<a href='https://github.com/NervJS/taro/issues/5998'>我提的taro issue</a>
