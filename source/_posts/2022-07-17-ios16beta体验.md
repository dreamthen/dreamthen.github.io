...
- 技术特性以及关注点.
  ...
  - ios 16 为了帮助使每行的长度在视觉上保持平衡,其中 TextKit,尤其是 TextKit 2,大大改进了换行算法,对于那些想要保持与 ios 15 相同外观以及追求'UI像素完美'的开发者可要注意哦~
    ...
    - 解决方案: 
      ...
      Tips: 转换为 TextKit 1 方法: <a href='https://pastebin.com/frXraWWV'>transform TextKit 1</a>
  ...
  - 真机相机在 ios 16 beta 版本中黑屏.
    ...
    <img src='https://image.white-than-wood.zone/ios16/camera/darkEmpty.png' style="width:40%;"/>
  
    - 解决方案:

      根据苹果开发者论坛可知,现阶段还不存在解决方案,还持续存在这种情况.

      <img src='https://image.white-than-wood.zone/ios16/camera/resolve.png'/>
